...
export function SettingsView({ config, onSave, onClose }: SettingsViewProps) {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-gray-900/95 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl overflow-y-auto text-sm text-gray-300">
      ...
      <div className="pt-4 mt-4 border-t border-white/10 text-center">
        <button
          onClick={onClose}
          className="text-gray-500 hover:text-white transition-colors text-xs uppercase tracking-widest font-bold"
        >
          Done
        </button>
      </div>
